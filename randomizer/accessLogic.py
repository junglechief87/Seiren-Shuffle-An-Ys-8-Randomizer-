...
def canAccess(inventory,location,parameters):
    ...
    if location.locRegion == 'White Sand Cape':
        ...
        if location.locName ==  'Intercept':
            ...
            if location.mapCheckID == 'Percent 10' and (access.canClimb() or access.canMove(8)) and access.canShowMap(): return True
            ...
            elif location.mapCheckID == 'Percent 40' and (access.canClimb() or access.canMove(6)) and (access.canMove(8) or access.canDoubleJump()) and access.canShowMap() and access.canSwampWalk() and (access.canInsect() or (access.past1() and access.canAncient() and access.canSmith())) and access.canMove(11): return True
